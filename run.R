...
if (Sys.info()["nodename"] == "markus-T430")              system('rsync -avzhe "ssh -i /home/aurelius/avaimet/t430-rsync-key" --progress --delete /home/aurelius/btsync/web/aanipaat/_site// muuankarski@kapsi.fi:sites/aanipaat.net/www/')